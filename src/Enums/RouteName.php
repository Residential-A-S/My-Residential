...
enum RouteName
{
    ...
    public function getMethod(): string
    {
        return match ($this) {
            ...
            self::Api_User_Update, self::Api_User_Delete, self::Api_Property_Create,
            self::Api_Property_Update, self::Api_Property_Delete, self::Api_Organization_Create,
            self::Api_Organization_Update, self::Api_Organization_Delete, self::Api_Forgot_Password_Reset => 'POST'
        };
    }
